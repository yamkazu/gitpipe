...
class TimeUtils {
    ...
    static final long MIN = 1000 * 60L;

    static final long HALFHOUR = MIN * 30L;

    static final long ONEHOUR = HALFHOUR * 2;

    static final long ONEDAY = ONEHOUR * 24L;

    static final long ONEYEAR = ONEDAY * 365L;
    ...
    static boolean isToday(Date date) {
        (System.currentTimeMillis() - date.getTime()) < ONEDAY
    }
     ...
     */
    static int minutesAgo(Date date, long endTime, boolean roundup) {
     ...
     * @return minutes ago
     */
    static int minutesAgo(Date date, boolean roundup) {
     ...
     * @return hours ago
     */
    static int hoursAgo(Date date, boolean roundup) {
